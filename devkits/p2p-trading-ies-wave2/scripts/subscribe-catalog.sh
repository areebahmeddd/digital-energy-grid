#!/usr/bin/env bash
# Subscribe a discover service to the catalog service for the P2P trading
  ...
  --data @- <<EOF
{
  "context": {
    ...
    "messageId": "c2af6d56-ed34-5158-9af9-64a1bcdf00d0",
    "transactionId": "49d5c042-decd-5543-c666-68c5a6c79130",
