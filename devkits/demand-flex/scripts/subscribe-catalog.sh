#!/usr/bin/env bash
# Subscribe a discover service to the catalog service for the demand-flex
...
# uc1-bdr-w-baselining/workflows/run-arazzo.sh. Re-running is idempotent.
...
networkID="energystackmum.tatapower.com/test-tatapower-mumbai-demand-flex-network"
