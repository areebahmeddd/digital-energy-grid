...
This collection provides schemas for credentials issued by electricity distribution utilities to consumers and prosumers. The credentials are designed to be privacy-preserving and follow the W3C VC Data Model 2.0.

## Available Credentials

| Credential | Description | Purpose |
|------------|-------------|---------|
| [Electricity Credential](./electricity-credential/) | Unified credential combining customer identity, consumption, generation, and storage profiles | Single credential per meter for consumer/prosumer identity |
...
- **customerDetails** — full name, installation address, service connection date

In the Electricity Credential these are required; in the Program Enrollment Credential they are optional.
