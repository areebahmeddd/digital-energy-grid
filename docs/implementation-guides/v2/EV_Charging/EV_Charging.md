...
Step 1 : Download the postman collection, from [here](/devkits/ev-charging/postman/).
...
```json
{
  "context": {
    ...
    "ttl": "PT30S",
    "schema_context": [
      "https://schema.beckn.io/EvChargingService/1.0/context.jsonld"
    ]
  },
  "message": {
    "filters": {
        ...
        "beckn:items": [
          {
            ...
            "beckn:itemAttributes": {
              "@context": "https://schema.beckn.io/EvChargingService/1.0/context.jsonld",
        ...
        "beckn:offers": [
          {
            ...
            "beckn:offerAttributes": {
              "@context": "https://schema.beckn.io/EvChargingOffer/1.0/context.jsonld",
              "@type": "ChargingOffer",
              "tariffModel": "PER_KWH",
              "idleFeePolicy": {
                "currency": "INR",
  ...
  "message": {
    "order": {
      ...
      "beckn:orderAttributes": {
        "@context": "https://schema.beckn.io/EvChargingSession/1.0/context.jsonld",
